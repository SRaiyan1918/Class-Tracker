  ...
  const treeData = useMemo(() => {
    ...
    sorted.forEach(c => {
      ...
      if (!tree[subj][chap]._count[topic]) {
        tree[subj][chap]._order.push(topic);
      }
...
<div class="page">
  ...
  <!-- Footer with Contact -->
  <div class="footer">
    Generated by ClassTracker &nbsp;•&nbsp; ${new Date().toLocaleString('en-IN')}
    <br/><br/>
    📬 Contact Us: <a href="https://t.me/+Wu_U6OE5eahlMjJl">t.me/+Wu_U6OE5eahlMjJl</a>
  </div>
</div>
  ...
  return (
    <section className="tab-content active">
      ...
      <div style={{
        ...
        📬 Contact Us:{' '}
        <a
          href="https://t.me/+Wu_U6OE5eahlMjJl"
          target="_blank"
